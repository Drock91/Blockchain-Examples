...
* Heroku node.js App - Contains index.js-Includes necessary XRPL libraries for crypto signing 
  ...
  - [index.js](xrplintegrations.js) contains market order purchasing for registration if player needs to purchase DKP, it also has Xumm webhooks and other various calls to the XRP Ledger to include sending DKP to the player for transmuting in-game gold currency generated by playfab to DKP
